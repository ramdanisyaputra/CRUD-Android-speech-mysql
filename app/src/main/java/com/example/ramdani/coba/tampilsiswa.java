...
public class tampilsiswa extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tampilsiswa);
    ...
    private void showEmployee(String json){
        try {
            ...
            String rombel = c.getString(konfigurasi.TAG_ROMBEL);

            txtSpeechInput.setText(nama);
            editTextRombel.setText(rombel);
    ...
    private void updateEmployee(){
        ...
        class UpdateEmployee extends AsyncTask<Void,Void,String>{
            ...
            protected String doInBackground(Void... params) {
                ...
                hashMap.put(konfigurasi.KEY_EMP_ROMBEL,rombel);
